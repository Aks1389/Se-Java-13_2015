...
public class AddFilmPositive extends selenium.tests.pages.TestBase {
	...
	public void testAddFilm() throws Exception {
		...
		WebElement movieField = driver.findElement(By.xpath("//table//td/input[@name=\"name\"]"));
		movieField.clear();
		movieField.sendKeys(movie_name);
		movieField.sendKeys(Keys.TAB);
		try {
